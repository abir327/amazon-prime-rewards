...
@media screen and (max-width: 900px) {
    ...
    * {
    ...
    /* Hide desktop nav */
    #nav-belt, #nav-main, #navbar, header, #nav-tools {
    ...
    div[class*="bxcGridColumn"], div[class*="bxcGridRow"] {
        ...
        min-width: 0 !important;
        margin: 0 !important;
        padding: 0 10px !important; /* give some padding for text */
    ...
    /* Footer fixes - DONT HIDE THE WHOLE SPRITE JUST HIDE IT IN HEADER */
...
print("Final responsive applied.")
