...
@media screen and (max-width: 900px) {
    ...
    * {
    ...
    /* Hide ALL possible desktop navigation elements and sprite containers */
    ...
    .nav-fill, #nav-search, .nav-sprite, .nav-logo, .nav-icon, #nav-logo, #nav-search-form {
        display: none !important;
    }
    
    /* Hide any direct child images of body that might be pre-load sprites */
    body > img, #a-page > img {
        display: none !important;
    }
