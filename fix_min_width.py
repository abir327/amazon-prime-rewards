...
@media screen and (max-width: 768px) {
    ...
    * {
    ...
    ._Y29ud_bxcGridContainerWidth1500_36D4w, ._Y29ud_bxcGridContainerWidth1024_1vBWD, ._Y29ud_bxcGridContainerWidth1170_cveg0, ._Y29ud_bxcGridContainerWidth1280_1NCXp, ._Y29ud_bxcGridContainerWidth1366_1uBBT {
        width: 100% !important;
        max-width: 100% !important;
        min-width: 0 !important;
    }
...
content = re.sub(r'<style>\n/\* Safe mobile responsive overrides.*?</style>\n', '', content, flags=re.DOTALL)
content = re.sub(r'<style>/\* Safe mobile responsive overrides.*?</style>', '', content, flags=re.DOTALL)
